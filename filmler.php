						...
						<div class="filter__items">
							...
							<div class="filter__item" id="filter__genre">
								...
								<div class="filter__item-btn dropdown-toggle" role="navigation" id="filter-genre" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									...
									<input type="hidden" name="film_turu" id="film_turu">
									<span></span>
								</div>
							...
							<div class="filter__item" id="filter__quality">
								...
								<div class="filter__item-btn dropdown-toggle" role="navigation" id="filter-quality" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<input type="button" value="4K">
									<input type="hidden" value="4K" name="film_kalite" id="film_kalite">
									<span></span>
								</div>

								<ul id="kalite" class="filter__item-menu dropdown-menu scrollbar-dropdown" aria-labelledby="filter-quality">
									<li class="film_kalite" value="4K">4K</li>
									<li class="film_kalite" value="1080P">1080P</li>
									<li class="film_kalite" value="720P">720P</li>
									<li class="film_kalite" value="640P">640P</li>
									<li class="film_kalite" value="480P">480P</li>
									<li class="film_kalite" value="360P">360P</li>
								</ul>
							</div>
							<!-- end filter item -->
							...
							<div class="filter__item" id="filter__rate">
								...
								<div class="filter__item-btn dropdown-toggle" role="button" id="filter-rate" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<div class="filter__range">
										<div id="filter__imbd-start" name="film_imdb_start" value=""></div>
										<div id="filter__imbd-end" name="film_imdb_end" value=""></div>
										<input type="hidden" value="2.5" name="film_imdb_start" id="film_imdb_start">
										<input type="hidden" value="8.6" name="film_imdb_end" id="film_imdb_end">
									</div>
									<span></span>
								</div>
							...
							<div class="filter__item" id="filter__year">
								...
								<div class="filter__item-btn dropdown-toggle" role="button" id="filter-year" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<div class="filter__range">
										<div id="filter__years-start" name="film_yil_start" value=""></div>
										<div id="filter__years-end" name="film_yil_end" value=""></div>
										<input type="hidden" value="2005" name="film_yil_start" id="film_yil_start">
										<input type="hidden" value="2010" name="film_yil_end" id="film_yil_end">
									</div>
									<span></span>
								</div>
	...
	<div class="catalog">
		<div class="container">
			<div class="row">
				...
				<?php
$limit = 12;
$query = "SELECT * FROM filmler ORDER BY filmid DESC";
...
$show = "SELECT * FROM filmler ORDER BY filmid DESC LIMIT $starting_limit, $limit";
...
<?php endfor; ?>
	...
	<script src="js/main.js?v=2.2.1"></script>
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('.film-kalite').click(function () {
				var val = $(this).attr('value');
				$('#film_kalite').val(val);
			});

			$('form#filtreuygula').submit(function (event) {
				if($('#film_turu').val() == 0){
					Swal.fire(
						  'Hata',
						  'Filtre için kategori seçmediniz.',
						  'error',
					);
